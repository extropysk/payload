...
describe('Payload', () => {
  ...
  describe('constructor', () => {
    ...
    it('should merge provided config with defaults', () => {
      const p = new Payload({ baseUrl: 'https://test.com' })
  ...
  describe('request', () => {
    ...
    it('should include bearer token when getBearerToken returns value', async () => {
      const payloadWithToken = new Payload<Collections>({
    ...
    it('should not include Authorization header when getBearerToken returns null', async () => {
      const payloadWithNullToken = new Payload<Collections>({
        baseUrl: 'https://api.example.com',
        getBearerToken: () => null,
      })
      mockAjax.mockResolvedValue({})
    ...
    it('should pass options from config', async () => {
      const payloadWithOptions = new Payload<Collections>({
        baseUrl: 'https://api.example.com',
        options: { credentials: 'include' },
      })
      mockAjax.mockResolvedValue({})
